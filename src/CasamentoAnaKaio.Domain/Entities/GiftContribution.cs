...
public class GiftContribution
{
    ...
    public void MarkAsPending() => PaymentStatus = PaymentStatus.Pending;

    public void MarkAsProcessing() => PaymentStatus = PaymentStatus.Processing;

    public void MarkAsCancelled() => PaymentStatus = PaymentStatus.Cancelled;

    public void MarkAsRefunded() => PaymentStatus = PaymentStatus.Refunded;

    public void MarkAsChargedBack() => PaymentStatus = PaymentStatus.ChargedBack;

    public void MarkAsExpired() => PaymentStatus = PaymentStatus.Expired;
