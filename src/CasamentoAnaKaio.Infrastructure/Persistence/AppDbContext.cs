...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.Property(x => x.PreferenceId).HasMaxLength(120).IsRequired();
            entity.Property(x => x.InitPoint).HasMaxLength(1000).IsRequired();
            entity.Property(x => x.SandboxInitPoint).HasMaxLength(1000).IsRequired();
            entity.Property(x => x.ExternalReference).HasMaxLength(160).IsRequired();
            ...
            entity.Property(x => x.QrCode).HasColumnType("text").IsRequired();
            ...
            entity.HasOne<GiftContribution>().WithMany().HasForeignKey(x => x.GiftContributionId);
        });
    }
}
